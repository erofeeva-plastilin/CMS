...
Красными точками выделены снипы из статьи, зеленым - снипы, обнаруженные в результате анализа. Сверу подписаны позиции снипов, снизу подписаны расстояния между ближайшими снипами из статьи и нашего анализа
